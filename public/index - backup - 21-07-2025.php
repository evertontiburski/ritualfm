    ...
    <body>
        ...
        <div id="mini_player">
            ...
            <div class="social socialplayer">
                <a href="/instagram" target="new">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" fill="#fff" viewBox="0 0 48 48">
                ...
                <a href="/twitch" target="new">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" fill="#fff" viewBox="0 0 50 50">
                ...
                <a href="/x" target="new">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" fill="#fff" viewBox="0 0 48 48">
        ...
        <script src="<?= URL ?>/public/js/player.js"></script>
        <script src="<?= URL ?>/public/js/proccess.js"></script>
