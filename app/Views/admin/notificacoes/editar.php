    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-content-header">
                <div>
                    <h2>Editar Mensagem de Notificação</h2>
                    <p class="subtitle">Lembre-se que o Título, suporta até 255 caracteres.</p>
                </div>
                <div class="header-actions">
                    <a href="<?= URL . '/admin/notificacoes' ?>" class="btn btn-create ajax-link">
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/notificacoes/editar/<?= $dados->notificacao->id_notificacao ?>" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="titulo">Título</label>
                        <input type="text" name="titulo" id="titulo" class="form-control" value="<?= $dados->notificacao ? $dados->notificacao->titulo : "" ?>"><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-container">
                            ...
                            <div id="editor" contenteditable="true">
                                <?= $dados->notificacao ? $dados->notificacao->texto : "" ?>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="1" <?php if ($dados->notificacao->status == '1'): ?> selected <?php endif; ?>>Ativado</option>
                                <option value="0" <?php if ($dados->notificacao->status == '0'): ?> selected <?php endif; ?>>Desativado</option>
                            </select>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Editar Notificação</button>
                    </div>
