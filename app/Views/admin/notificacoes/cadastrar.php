    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-content-header">
                <div>
                    <h2>Cadastrar Mensagem de Notificação</h2>
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/notificacoes/cadastrar" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Cadastrar Notificação</button>
                    </div>
