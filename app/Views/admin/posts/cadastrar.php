    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/posts/cadastrar" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Cadastrar Post</button>
                    </div>
