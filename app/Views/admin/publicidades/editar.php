    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-content-header">
                <div>
                    <h2>Editar Publicidade</h2>
                    <p class="subtitle">Lembre-se que o Título, e Subtítulo suporta até 255 caracteres.</p>
                </div>
                <div class="header-actions">
                    <a href="<?= URL . '/admin/publicidades' ?>" class="btn btn-create ajax-link">
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/publicidades/editar/<?= $dados->publicidade->id_publicidade ?>" enctype="multipart/form-data">

                    <div class="form-group" data-component="file-input">

                        <input type="file"
                            name="imagem_publicidade"
                            id="imagem_publicidade"
                            class="input-file-hidden"
                            accept=".png, .jpeg, .jpg"
                            data-role="file-input-target">

                        <label for="imagem_publicidade" class="custom-file-upload">
                            <span class="btn btn-primary file-button">
                                <?php
                                // Lógica do botão (não muda)
                                if ($dados->publicidade->id_publicidade) {
                                    echo 'Alterar imagem';
                                } else {
                            ...
                            <span class="file-name"
                                ...
                                data-original-text="<?php
                                                    ...
                                                    if ($dados->publicidade->imagem_publicidade && $dados->publicidade->imagem_publicidade) {
                                                        echo htmlspecialchars($dados->publicidade->imagem_publicidade);
                                                    } elseif ($dados->publicidade->imagem_publicidade && $dados->publicidade->imagem_publicidade == null) {
                                                        echo 'Publicidade sem imagem';
                                                    } else {
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="titulo" id="titulo" class="form-control" value="<?= $dados->publicidade ? $dados->publicidade->titulo : "" ?>"><br>
                    </div>
                    <div class="form-group">
                        <label for="subtitulo">Subtítulo</label>
                        <input type="text" name="subtitulo" id="subtitulo" class="form-control" value="<?= $dados->publicidade ? $dados->publicidade->subtitulo : "" ?>"><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-container">
                            ...
                            <div id="editor" contenteditable="true">
                                <?= $dados->publicidade ? $dados->publicidade->texto : ""; ?>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="categoria_id" id="categoria_id" class="form-control">
                                ...
                                <?php foreach ($dados->categorias as $categoria): ?>
                                    <option value="<?= $categoria->id_categoria ?>" <?php if ($dados->publicidade->categoria_id): ?> selected <?php endif; ?>><?= $categoria->titulo ?></option>
                                <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="1" <?php if ($dados->publicidade->status == '1'): ?> selected <?php endif; ?>>Ativado</option>
                                <option value="0" <?php if ($dados->popublicidadest->status == '0'): ?> selected <?php endif; ?>>Desativado</option>
                            </select>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Editar Publicidade</button>
                    </div>
