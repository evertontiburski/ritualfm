    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/eventos/cadastrar" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-container">
                            ...
                            <div id="editor" contenteditable="true">
                                <?= '<p>Comece a escrever a descrição aqui, máximo 255 caracteres...</p>'; ?>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="atracao" id="atracao" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="local" name="local" id="local" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="video_id_youtube">Video id youtube</label>
                        <input type="video_id_youtube" name="video_id_youtube" id="video_id_youtube" class="form-control">
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Cadastrar Evento</button>
                    </div>
