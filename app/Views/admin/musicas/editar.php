    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-content-header">
                <div>
                    <h2>Editar Conteúdo de Música</h2>
                    <p class="subtitle">O Título e Subtítulo suportam até 255 caracteres.</p>
                </div>
                <div class="header-actions">
                    <a href="<?= URL . '/admin/musicas' ?>" class="btn btn-create ajax-link">
            ...
            <div class="admin-content-box">
                <form class="admin-form" method="post" action="<?= URL ?>/admin/musicas/editar/<?= $dados->musica->id_musica ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group" data-component="file-input">
                        ...
                        <label for="imagem_musica" class="custom-file-upload">
                            <span class="btn btn-primary file-button">
                                <?php
                                // Lógica do botão (não muda)
                                if ($dados->musica->id_musica) {
                                    echo 'Alterar imagem';
                                } else {
                            ...
                            <span class="file-name"
                                ...
                                data-original-text="<?php
                                                    ...
                                                    if ($dados->musica->id_musica && $dados->musica->imagem_musica) {
                                                        echo htmlspecialchars($dados->musica->imagem_musica);
                                                    } elseif ($dados->musica->id_musica && $dados->musica->imagem_musica == null) {
                                                        echo 'Conteúdo de música sem imagem';
                                                    } else {
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="titulo" id="titulo" class="form-control" value="<?= $dados->musica ? $dados->musica->titulo : "" ?>">
                    </div>
                    <div class="form-group">
                        <label for="subtitulo">Subtítulo</label>
                        <input type="text" name="subtitulo" id="subtitulo" class="form-control" value="<?= $dados->musica ? $dados->musica->subtitulo : "" ?>">
                    </div>


                    <div class="form-group">
                        <label>Texto do conteúdo de música</label>
                        <div class="editor-container">
                            ...
                            <div id="editor" contenteditable="true">
                               <?= $dados->musica ? $dados->musica->texto : "" ?>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="artista" id="artista" class="form-control" value="<?= $dados->musica ? $dados->musica->artista : "" ?>">
                        </div>

                        <div class="form-group">
                            <label for="album">Album</label>
                            <input type="text" name="album" id="album" class="form-control" value="<?= $dados->musica ? $dados->musica->album : "" ?>">
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" name="lancamento" id="lancamento" class="form-control" value="<?= $dados->musica ? (new DateTime($dados->musica->lacamento))->format('Y-m-d') : "" ?>">
                        </div>

                        <div class="form-group">
                            <label for="player_id">Link do player</label>
                            <input type="text" name="player_id" id="player_id" class="form-control" value="<?= $dados->musica ? $dados->musica->player_id : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="categoria_id" id="categoria_id" class="form-control">
                                ...
                                <?php foreach ($dados->categorias as $categoria): ?>
                                    <option value="<?= $categoria->id_categoria ?>"<?php if ($dados->musica->categoria_id == $categoria->id_categoria): ?>selected<?php endif; ?>><?= $categoria->titulo ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="1" <?php if ($dados->musica->status == '1'): ?> selected <?php endif; ?>>Ativado</option>
                                <option value="0" <?php if ($dados->musica->status == '0'): ?> selected <?php endif; ?>>Desativado</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Editar Conteúdo de Música</button>
                    </div>
