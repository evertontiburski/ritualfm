    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-content-header">
                <div>
                    <h2>Cadastrar Novo Conteúdo de Música</h2>
            ...
            <div class="admin-content-box">
                <form class="admin-form" method="post" action="<?= URL ?>/admin/musicas/cadastrar" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-container">
                            ...
                            <div id="editor" contenteditable="true">
                                <?= '<p>Comece a escrever o texto aqui...</p>'; ?>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Cadastrar Música</button>
                    </div>
