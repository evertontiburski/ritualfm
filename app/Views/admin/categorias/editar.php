        ...
        <main class="admin-content">
            <div class="admin-content-header">
                ...
                <div class="header-actions">
                    <a href="<?= URL . '/admin/categorias' ?>" class="btn btn-create ajax-link">
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/categorias/editar/<?= $dados->categoria->id_categoria ?>">

                    <div class="form-group">
                        <label class="" for="titulo">Título</label>
                        <input type="text" name="titulo" id="titulo" class="form-control" value="<?= $dados->categoria ? $dados->categoria->titulo : "" ?>"><br>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="editor-container">
                            ...
                            <div id="editor" contenteditable="true">
                                <?= $dados->categoria ? $dados->categoria->texto : "" ?>
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="1" <?php if ($dados->categoria->status == '1'): ?> selected <?php endif; ?>>Ativado</option>
                                <option value="0" <?php if ($dados->categoria->status == '0'): ?> selected <?php endif; ?>>Desativado</option>
                            </select>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Editar Categoria</button>
                    </div>
