    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="admin-content-header">
                <div>
                    <h2>Editar Termos e Condições</h2>
                    <p class="subtitle">Lembre-se que o Título, suporta até 255 caracteres.</p>
                </div>
                <div class="header-actions">
                    <a href="<?= URL . '/admin/termos' ?>" class="btn btn-create ajax-link">
            ...
            <div class="admin-content-box">
                ...
                <form class="admin-form" method="post" action="<?= URL ?>/admin/termos/editar/<?= $dados->termo->id_termo ?>" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="titulo">Título</label>
                        <input type="text" name="titulo" id="titulo" class="form-control" value="<?= $dados->termo ? $dados->termo->titulo : "" ?>"><br>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="1" <?php if ($dados->termo->status == '1'): ?> selected <?php endif; ?>>Ativado</option>
                                <option value="0" <?php if ($dados->termo->status == '0'): ?> selected <?php endif; ?>>Desativado</option>
                            </select>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-primary ajax-link">Editar Termos</button>
                    </div>
