...
function(e, t, n, r) {
    var i = n(e),
        ...
        l = function(e, t) {
            return t && f(e) && 0 < e.indexOf("%") && (e = o.getViewport()[t] / 100 * parseInt(e, 10)), Math.round(e) + "px"
        };
    n.extend(o, {
        version: "2.0.5",
        defaults: {
        ...
        helpers: {},
        open: function(e, t) {
            o.close(!0), e && !n.isArray(e) && (e = e instanceof n ? n(e).get() : [e]), o.isActive = !0, o.opts = n.extend(!0, {}, o.defaults, t), n.isPlainObject(t) && t.keys !== r && (o.opts.keys = t.keys ? n.extend({}, o.defaults.keys, t.keys) : !1), o.group = e, o._start(o.opts.index || 0)
        },
        cancel: function() {
        ...
        close: function(e) {
            o.cancel(), o.current && !1 !== o.trigger("beforeClose") && (o.unbindEvents(), !o.isOpen || e && !0 === e[0] ? (n(".fancybox-wrap").stop().trigger("onReset").remove(), o._afterZoomOut()) : (o.isOpen = o.isOpened = !1, n(".fancybox-item, .fancybox-nav").remove(), o.wrap.stop(!0).removeClass("fancybox-opened"), o.inner.css("overflow", "hidden"), o.transitions[o.current.closeMethod]()))
        },
        play: function(e) {
            var t = function() {
            ...
            o.player.isActive || e && !1 === e[0] ? i() : o.current && (o.current.loop || o.current.index < o.group.length - 1) && (o.player.isActive = !0, n("body").bind({
        ...
        jumpto: function(e) {
            o.current && (e = parseInt(e, 10), 1 < o.group.length && o.current.loop && (e >= o.group.length ? e = 0 : 0 > e && (e = o.group.length - 1)), o.group[e] !== r && (o.cancel(), o._start(e)))
        },
        reposition: function(e, t) {
            var n;
            o.isOpen && (n = o._getPosition(t), e && "scroll" === e.type ? (delete n.position, o.wrap.stop(!0, !0).animate(n, 200)) : o.wrap.css(n))
        },
        update: function(e) {
            o.isOpen && (u || setTimeout(function() {
                var t = o.current,
                    n = !e || e && "orientationchange" === e.type;
                if (u && (u = !1, t)) {
                    if (!e || "scroll" !== e.type || n) t.autoSize && "iframe" !== t.type && (o.inner.height("auto"), t.height = o.inner.height()), (t.autoResize || n) && o._setDimension(), t.canGrow && "iframe" !== t.type && o.inner.height("auto");
                    (t.autoCenter || n) && o.reposition(e), o.trigger("onUpdate")
                }
            }, 200), u = !0)
        },
        toggle: function() {
        ...
        showLoading: function() {
            o.hideLoading(), s.bind("keypress.fb", function(e) {
                27 === e.keyCode && (e.preventDefault(), o.cancel())
            }), n('<div id="fancybox-loading"><div></div></div>').click(o.cancel).appendTo("body")
        },
        ...
        unbindEvents: function() {
            o.wrap && o.wrap.unbind(".fb"), s.unbind(".fb"), i.unbind(".fb")
        },
        bindEvents: function() {
            var e = o.current,
                t = e.keys;
            e && (i.bind("resize.fb orientationchange.fb" + (e.autoCenter && !e.fixed ? " scroll.fb" : ""), o.update), t && s.bind("keydown.fb", function(e) {
                var r;
                r = e.target || e.srcElement, !e.ctrlKey && !e.altKey && !e.shiftKey && !e.metaKey && (!r || !r.type && !n(r).is("[contenteditable]")) && (r = e.keyCode, -1 < n.inArray(r, t.close) ? (o.close(), e.preventDefault()) : -1 < n.inArray(r, t.next) ? (o.next(), e.preventDefault()) : -1 < n.inArray(r, t.prev) && (o.prev(), e.preventDefault()))
            }), n.fn.mousewheel && e.mouseWheel && 1 < o.group.length && o.wrap.bind("mousewheel.fb", function(e, t) {
                var n = e.target || null;
                0 !== t && (!n || 0 === n.clientHeight || n.scrollHeight === n.clientHeight && n.scrollWidth === n.clientWidth) && (e.preventDefault(), o[0 < t ? "prev" : "next"]())
            }))
        },
        trigger: function(e, t) {
            var r, i = t || o[-1 < n.inArray(e, ["onCancel", "beforeLoad", "afterLoad"]) ? "coming" : "current"];
            if (i) {
                n.isFunction(i[e]) && (r = i[e].apply(i, Array.prototype.slice.call(arguments, 1)));
                if (!1 === r) return !1;
                i.helpers && n.each(i.helpers, function(t, r) {
                    r && n.isPlainObject(o.helpers[t]) && n.isFunction(o.helpers[t][e]) && o.helpers[t][e](r, i)
                }), n.event.trigger(e + ".fb")
            }
        },
        isImage: function(e) {
            return f(e) && e.match(/\.(jpe?g|gif|png|bmp)((\?|#).*)?$/i)
        },
        isSWF: function(e) {
        ...
        _start: function(e) {
            var t = {},
                r = o.group[e] || null,
                i, s, u;
            r && (r.nodeType || r instanceof n) && (i = !0, n.metadata && (t = n(r).metadata())), t = n.extend(!0, {}, o.opts, {
                index: e,
                element: r
            }, n.isPlainObject(r) ? r : t), n.each(["href", "title", "content", "type"], function(e, s) {
                t[s] = o.opts[s] || i && n(r).attr(s) || t[s] || null
            }), "number" == typeof t.margin && (t.margin = [t.margin, t.margin, t.margin, t.margin]), t.modal && n.extend(!0, t, {
                closeBtn: !1,
                closeClick: !1,
                nextClick: !1,
                arrows: !1,
            ...
            if (!1 === o.trigger("beforeLoad")) o.coming = null;
                ...
                s = t.type, e = t.href || r, s || (i && (s = n(r).data("fancybox-type"), s || (s = (s = r.className.match(/fancybox\.(\w+)/)) ? s[1] : null)), !s && f(e) && (o.isImage(e) ? s = "image" : o.isSWF(e) ? s = "swf" : e.match(/^#/) && (s = "inline")), s || (s = i ? "inline" : "html"), t.type = s);
                if ("inline" === s || "html" === s) {
                    if (t.content || (t.content = "inline" === s ? n(f(e) ? e.replace(/.*(?=#[^\s]+$)/, "") : e) : r), !t.content || !t.content.length) s = null
                } else e || (s = null);
                "ajax" === s && f(e) && (u = e.split(/\s+/, 2), e = u.shift(), t.selector = u.shift()), t.href = e, t.group = o.group, t.isDom = i;
                switch (s) {
                    case "image":
                        o._loadImage();
                        break;
        ...
        _setContent: function() {
            ...
            switch (r) {
                ...
                case "ajax":
                case "html":
                    e.selector ? t = n("<div>").html(t).find(e.selector) : t instanceof n && (t.parent().hasClass("fancybox-inner") && t.parents(".fancybox-wrap").unbind("onReset"), t = t.show().detach(), n(o.wrap).bind("onReset", function() {
                        t.appendTo("body").hide()
                    })), e.autoSize && (i = n('<div class="fancybox-wrap ' + o.current.wrapCSS + ' fancybox-tmp"></div>').appendTo("body").css({
                        minWidth: l(i, "w"),
                        minHeight: l(s, "h"),
                        maxWidth: l(u, "w"),
                        maxHeight: l(f, "h")
                    }).append(t), e.width = i.width(), e.height = i.height(), i.width(o.current.width), i.height() > e.height && (i.width(e.width + 1), e.width = i.width(), e.height = i.height()), t = i.contents().detach(), i.remove());
                    break;
                case "image":
                ...
                case "swf":
                    ...
                    break;
                case "iframe":
                    t = n(e.tpl.iframe.replace("{rnd}", (new Date).getTime())).attr("scrolling", e.scrolling).attr("src", e.href), e.scrolling = a ? "scroll" : "auto"
            }
            if ("image" === r || "swf" === r) e.autoSize = !1, e.scrolling = "visible";
            "iframe" === r && e.autoSize ? (o.showLoading(), o._setDimension(), o.inner.css("overflow", e.scrolling), t.bind({
                onCancel: function() {
                ...
                load: function() {
                    o.hideLoading();
                    try {
                        this.contentWindow.document.location && (o.current.height = n(this).contents().find("body").height())
                    } catch (e) {
                        o.current.autoSize = !1
                    }
                    o[o.isOpen ? "_afterZoomIn" : "_beforeShow"]()
                }
            }).appendTo(o.inner)) : (o.inner.append(t), o._beforeShow())
        },
        ...
        _setDimension: function() {
            var e = o.wrap,
                ...
                m = r.minHeight + u,
                g;
            i.w -= s[1] + s[3], i.h -= s[0] + s[2], f(a) && 0 < a.indexOf("%") && (a = (i.w - u) * parseFloat(a) / 100), f(c) && 0 < c.indexOf("%") && (c = (i.h - u) * parseFloat(c) / 100), s = a / c, a += u, c += u, r.fitToView && (h = Math.min(i.w, h), p = Math.min(i.h, p));
            if (r.aspectRatio) {
                if (a > h && (a = h, c = (a - u) / s + u), c > p && (c = p, a = (c - u) * s + u), a < v && (a = v, c = (a - u) / s + u), c < m) c = m, a = (c - u) * s + u
            } else a = Math.max(v, Math.min(a, h)), c = Math.max(m, Math.min(c, p));
            a = Math.round(a), c = Math.round(c), n(e.add(t)).width("auto").height("auto"), t.width(a - u).height(c - u), e.width(a), g = e.height();
            if (a > h || g > p)
                for (;
                    (a > h || g > p) && a > v && g > m;) c -= 10, r.aspectRatio ? (a = Math.round((c - u) * s + u), a < v && (a = v, c = (a - u) / s + u)) : a -= 10, t.width(a - u).height(c - u), e.width(a), g = e.height();
            r.dim = {
                width: l(a),
                height: l(g)
            }, r.canGrow = r.autoSize && c > m && c < p, r.canShrink = !1, r.canExpand = !1, a - u < r.width || c - u < r.height ? r.canExpand = !0 : (a > i.w || g > i.h) && a > v && c > m && (r.canShrink = !0), o.innerSpace = g - u - t.height()
        },
        _getPosition: function(e) {
            ...
            return t.autoCenter && t.fixed && !e && s <= n.h && i <= n.w && (u = {
                position: "fixed",
                top: r[0],
                left: r[3]
            }), u.top = l(Math.max(u.top, u.top + (n.h - s) * t.topRatio)), u.left = l(Math.max(u.left, u.left + .5 * (n.w - i))), u
        },
        _afterZoomIn: function() {
            var e = o.current,
                t = e ? e.scrolling : "no";
            e && (o.isOpen = o.isOpened = !0, o.wrap.addClass("fancybox-opened"), o.inner.css("overflow", "yes" === t ? "scroll" : "no" === t ? "hidden" : t), o.trigger("afterShow"), o.update(), (e.closeClick || e.nextClick) && o.inner.css("cursor", "pointer").bind("click.fb", function(t) {
                !n(t.target).is("a") && !n(t.target).parent().is("a") && o[e.closeClick ? "close" : "next"]()
            }), e.closeBtn && n(e.tpl.closeBtn).appendTo(o.skin).bind("click.fb", o.close), e.arrows && 1 < o.group.length && ((e.loop || 0 < e.index) && n(e.tpl.prev).appendTo(o.outer).bind("click.fb", o.prev), (e.loop || e.index < o.group.length - 1) && n(e.tpl.next).appendTo(o.outer).bind("click.fb", o.next)), o.opts.autoPlay && !o.player.isActive) && (o.opts.autoPlay = !1, o.play())
        },
        _afterZoomOut: function() {
            var e = o.current;
            o.wrap.trigger("onReset").remove(), n.extend(o, {
                group: {},
                opts: {},
                current: null,
                isActive: !1,
        ...
        getOrigPosition: function() {
            var e = o.current,
                ...
                u = 50,
                a = 50;
            return !i.length && e.isDom && n(t).is(":visible") && (i = n(t).find("img:first"), i.length || (i = n(t))), i.length ? (s = i.offset(), i.is("img") && (u = i.outerWidth(), a = i.outerHeight())) : (e = o.getViewport(), s.top = e.y + .5 * (e.h - a), s.left = e.x + .5 * (e.w - u)), s = {
                top: l(s.top - r),
                left: l(s.left - r),
                width: l(u + 2 * r),
                height: l(a + 2 * r)
        ...
        step: function(e, t) {
            var n = t.prop,
                r, i;
            if ("width" === n || "height" === n) r = Math.ceil(e - 2 * o.current.padding), "height" === n && (i = (e - t.start) / (t.end - t.start), t.start > t.end && (i = 1 - i), r -= o.innerSpace * i), o.inner[n](r)
        },
        zoomIn: function() {
            var e = o.wrap,
                t = o.current,
                r = t.openEffect,
                i = "elastic" === r,
                s = n.extend({}, t.dim, o._getPosition(i)),
                u = n.extend({
                    opacity: 1
                }, s);
            delete u.position, i ? (s = this.getOrigPosition(), t.openOpacity && (s.opacity = 0), o.outer.add(o.inner).width("auto").height("auto")) : "fade" === r && (s.opacity = 0), e.css(s).show().animate(u, {
        ...
        zoomOut: function() {
            ...
            r && ("fixed" === e.css("position") && e.css(o._getPosition(!0)), i = this.getOrigPosition(), t.closeOpacity && (i.opacity = 0)), e.animate(i, {
        ...
        changeIn: function() {
            ...
            i.opacity = 0, r && (i.top = l(parseInt(i.top, 10) - 200), s.top = "+=200px"), e.css(i).show().animate(s, {
        ...
        update: function() {
            var e, r;
            this.overlay.width("100%").height("100%"), n.browser.msie || a ? (e = Math.max(t.documentElement.scrollWidth, t.body.scrollWidth), r = Math.max(t.documentElement.offsetWidth, t.body.offsetWidth), e = e < r ? i.width() : e) : e = s.width(), this.overlay.width(e).height(s.height())
        },
        beforeShow: function(e) {
            this.overlay || (e = n.extend(!0, {}, o.defaults.helpers.overlay, e), this.overlay = n('<div id="fancybox-overlay"></div>').css(e.css).appendTo("body"), e.closeClick && this.overlay.bind("click.fb", o.close), o.current.fixed && !a ? this.overlay.addClass("overlay-fixed") : (this.update(), this.onUpdate = function() {
                this.update()
        ...
        beforeShow: function(e) {
            var t;
            if (t = o.current.title) t = n('<div class="fancybox-title fancybox-title-' + e.type + '-wrap">' + t + "</div>").appendTo("body"), "float" === e.type && (t.width(t.width()), t.wrapInner('<span class="child"></span>'), o.current.margin[2] += Math.abs(parseInt(t.css("margin-bottom"), 10))), t.appendTo("over" === e.type ? o.inner : "outside" === e.type ? o.wrap : o.skin)
        }
        ...
        var t = n(this),
            ...
            i, u = function(s) {
                var u = this,
                    a = i,
                    f;
                !s.ctrlKey && !s.altKey && !s.shiftKey && !s.metaKey && !n(u).is(".fancybox-wrap") && (s.preventDefault(), s = e.groupAttr || "data-fancybox-group", f = n(u).attr(s), f || (s = "rel", f = u[s]), f && "" !== f && "nofollow" !== f && (u = r.length ? n(r) : t, u = u.filter("[" + s + '="' + f + '"]'), a = u.index(this)), e.index = a, o.open(u, e))
            },
            e = e || {};
        return i = e.index || 0, r ? s.undelegate(r, "click.fb-start").delegate(r, "click.fb-start", u) : t.unbind("click.fb-start").bind("click.fb-start", u), this
    }, n(t).ready(function() {
        o.defaults.fixed = n.support.fixedPosition || !(n.browser.msie && 6 >= n.browser.version) && !a
    })
}(window, document, jQuery),
function(e) {
    e.fn.slideto = function(t) {
        var n = e.extend({}, e.fn.slideto.defaults, t),
            r = this.length > 0 ? this : "a";
        return e(r).each(function() {
            var t = e(this),
                r = e.meta ? e.extend({}, n, t.data()) : n,
                i = e(t).attr("href"),
                s = "";
            if (i && i.indexOf("#") != -1 && i.indexOf("#") == 0) {
                var o = i.split("#", 2);
                s = e("a[name='" + o[1] + "']"), e(this).attr("href", "javascript:void(0);")
            } else s = e(r.target);
            e(t).bind("click", function() {
                e("html, body").animate({
                    scrollTop: s.offset().top,
                    scrollLeft: s.offset().left
                }, r.speed)
            })
        }), this
    }, e.fn.slideto.defaults = {
        target: !1,
        speed: 1500
    }
}(jQuery),
    ...
    e.fn.extend({
        filter_input: function(t) {
            function i(n) {
                ...
                if (i == 8 || i == 9 || i == 13 || i == 35 || i == 36 || i == 37 || i == 39 || i == 46)
                    if (e.browser.mozilla && n.charCode == 0 && n.keyCode == i) return !0;
                var s = String.fromCharCode(i);
                return r.test(s) ? !0 : (typeof t.feedback == "function" && t.feedback.call(this, s), !1)
            }
            var n = {
                    regex: ".*",
                    live: !1
            ...
            if (!t.live) return this.each(function() {
                var t = e(this);
                t.unbind("keypress").keypress(i)
            });
            e(this).live("keypress", i)
        }
    })
    ...
    v.defaults = {}, a(v.prototype, {
            spin: function(e) {
                ...
                e && (e.insertBefore(i, e.firstChild || null), a = f(e), o = f(i), u(i, {
                    left: (n.left == "auto" ? a.x - o.x + (e.offsetWidth >> 1) : parseInt(n.left, 10) + s) + "px",
                    top: (n.top == "auto" ? a.y - o.y + (e.offsetHeight >> 1) : parseInt(n.top, 10) + s) + "px"
...
var spinOptions = {
    ...
    createSpinner = function() {
        var e = $("#fancybox-loading").first(),
            t = (new Spinner(spinOptions)).spin(e[0])
    };
$(document).ready(function(e) {
    ...
    function r() {
        return e(".fancybox-chrome")
    }
    e("dl.tabs dd a").on("click.fndtn", function(n) {
        t(e(this).parent("dd"))
    });
    if (window.location.hash) {
        t(e('a[href="' + window.location.hash + '"]').parent("dd"));
        try {
            e.foundation.customForms.appendCustomMarkup()
        } catch (n) {}
    }
    var i = document.createTouch !== undefined;
    e(".various").fancybox({
        type: "iframe",
        scrolling: "no",
        fitToView: i,
        ...
        closeBtn: !0,
        beforeLoad: function() {
            setTimeout(createSpinner, 10)
        },
        beforeShow: function() {
            i || (e("body").css("overflow", "hidden"), e(".fancybox-wrap").wrap("<div class='fancybox-chrome' />"), r().on("click", function(t) {
                e.fancybox.close()
            }), r().resize())
        },
        afterClose: function() {
            i || (e("body").css("overflow", "auto"), r().remove())
        }
    }), e(".login_box").fancybox({
        width: 320,
        height: 290,
        autoWidth: !1,
        autoHeight: !0,
